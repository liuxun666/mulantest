...
public abstract class M {
	 ...
	 */
	public static double[] flatten(double M_[][]) throws Exception {
	...
	*/
	...
	public static double[][] multiply(final double[][] A, final double[][] B) {
		...
		int bRows = B.length;//��ʾ��B���������
		int bCols = B[0].length;//��ʾ��B���������

		if (aCols != bRows) // no can do��A�������������B�����������ܹ������г˷�
	...
	// constant��������CD����ķ����󣬾��Ǹ�CD�����ÿ��Ԫ��������-1��ԭ���Ĵ�����ת��Ϊ����Сֵ��ԭ������Сֵ�ͱ�������ֵ
	//��������ֵ��double CD[��ǩ����][��ǩ����Ŀ]���洢�ı�ǩ֮��Ĺ����ԣ��Ƿ���������double K=-1��
	public static double[][] multiply(final double[][] A, double K) {
        //����A�����Ǹ���ά���飬��ôA.length��ָ��λ�����м��У�A[0].length��ָ��ά�����е�0����ӵ�е�Ԫ������Ҳ��������
	...
	public static double[][] subtract(double[][] A, double[][] B) {
		//��ά�����length��ʾ�Ķ�ά���������
		//if (A.length != bRows) // no can do��ʾ����˼��A������������B����������ôʲô����������
		//	throw new IllegalArgumentException(" A.cols ("+aCols+") != B.rows ("+bRows+") ");
        double[][] C = new double[A.length][A[0].length];
        for (int i = 0; i < A.length; i++) {
            for (int j = 0; j < A[i].length; j++ ) {
